...
public class Email_Password_Testing {
    ...
    public void setPasswordPage() {
        ...
        driver.get("https://bit-by-bit-auto-sales.herokuapp.com/Login.ejs");

        driver.findElement(By.id("username")).sendKeys("admin");
        driver.findElement(By.id("password")).sendKeys("12345");
        driver.findElement(By.id("loginSubmit")).click();

        driver.get("https://bit-by-bit-auto-sales.herokuapp.com/ChangePassword.ejs"); // get the URL for password change page

        driver.findElement(By.id("username")).sendKeys("aziz"); // Add the username here
        driver.findElement(By.id("oldPassword")).sendKeys("12345"); // Add the old password here
        driver.findElement(By.id("newPassword")).sendKeys("12345"); // Add the new password here
        ...
        if (strURL.equals("https://bit-by-bit-auto-sales.herokuapp.com/ChangePassword.ejs")) { // check the currant page with successful password change page
            System.out.println("Test passed");
        }
        else {
            System.out.println("Test filed");
