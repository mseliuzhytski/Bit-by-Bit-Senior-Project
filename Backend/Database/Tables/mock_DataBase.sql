...
INSERT INTO INVENTORY (Car_Make, Car_Model, Car_Year, Car_Price, Car_Mileage, Car_BodyType, Car_Condition, Car_Color)
VALUES ('BMW', 'M3 Competition xDrive', '2022', '85000', '70', 'Sedan', 'New', 'Sao Paulo Yellow');
...
INSERT INTO EMPLOYEE (Emp_Username, Emp_PasswordHash, Emp_FirstName, Emp_LastName, Emp_Role)
VALUES ('chrisRS1212', '9ed083b1436e5f40ef984b28255eef18', 'Chris', 'Smith', 'Sales Person');

INSERT INTO EMPLOYEE (Emp_Username, Emp_PasswordHash, Emp_FirstName, Emp_LastName, Emp_Role)
VALUES ('johnGreen01', '57336afd1f4b40dfd9f5731e35302fe5', 'John', 'Green', 'Finance Manager');

INSERT INTO EMPLOYEE (Emp_Username, Emp_PasswordHash, Emp_FirstName, Emp_LastName, Emp_Role)
VALUES ('erik123', '230d3b2452c6b7e32b74b2beae943a49', 'Erik', 'Johnson', 'Sales Person');

INSERT INTO EMPLOYEE (Emp_Username, Emp_PasswordHash, Emp_FirstName, Emp_LastName, Emp_Role)
VALUES ('gummybear916', 'ec9903c79dd510ffa43f69ee867a9002', 'Justin', 'Jones', 'Sales Person');


/* Mohammed(4) and Erik(34) get two phone numbers */
...
INSERT INTO PHONE (Emp_ID, Emp_phone)
VALUES ('14', '9162335555');

INSERT INTO PHONE (Emp_ID, Emp_phone)
VALUES ('24', '9167776161');

INSERT INTO PHONE (Emp_ID, Emp_phone)
VALUES ('34', '8054442222');

INSERT INTO PHONE (Emp_ID, Emp_phone)
VALUES ('34', '9162662121');

INSERT INTO PHONE (Emp_ID, Emp_phone)
VALUES ('44', '9165551111');


/* Mohammed(4) and Justin(44) get two email addresses */
INSERT INTO EMAIL (Emp_ID, Emp_Email)
VALUES ('4', 'mohammed@okaidiautosales.com');

INSERT INTO EMAIL (Emp_ID, Emp_Email)
VALUES ('4', 'mohammed333@gmail.com');

INSERT INTO EMAIL (Emp_ID, Emp_Email)
VALUES ('14', 'chris@okaidiautosales.com');

INSERT INTO EMAIL (Emp_ID, Emp_Email)
VALUES ('24', 'john@okaidiautosales.com');

INSERT INTO EMAIL (Emp_ID, Emp_Email)
VALUES ('34', 'erik@okaidiautosales.com');

INSERT INTO EMAIL (Emp_ID, Emp_Email)
VALUES ('44', 'justin@okaidiautosales.com');

INSERT INTO EMAIL (Emp_ID, Emp_Email)
VALUES ('44', 'justin121@gmail.com');